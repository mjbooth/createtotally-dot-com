export const CreativeAutomationPageData = {
  metadata: {
    title: "Creative Automation for Modern Marketing Teams | CreateTOTALLY",
    description: "Automate repetitive design tasks in Figma or Adobe CC. CreateTOTALLY helps you scale creative production without compromising quality or brand integrity.",
    openGraph: {
      title: "Scale Creative Production with Automation",
  ...
  ctaData: {
    title: "See how you can deliver scalable content production.",
