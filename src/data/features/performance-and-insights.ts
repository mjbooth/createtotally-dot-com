export const PerformanceAndInsightsPageData = {
  metadata: {
    title: "Creative Performance & Insights Built In | CreateTOTALLY",
    description: "Track how your creatives perform across channels. Use real data to inform better design and drive iterative improvements at scale.",
    openGraph: {
      title: "Unlock Creative Insights with Built-In Performance Data",
      description: "See what works and what doesn’t. Measure and iterate your creative based on live performance feedback.",
      images: [
        {
  ...
  ctaData: {
    title: "See how you can transform data into a creative advantage",
...
export const {
  ...
  testimonialData,
  ctaData
} = PerformanceAndInsightsPageData;