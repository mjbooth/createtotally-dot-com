export const EasyTemplatingPageData = {
  metadata: {
    title: "Easy Creative Templating in Figma & Adobe | CreateTOTALLY",
    description: "Turn existing designs into reusable templates—no devs or plugins needed. Let marketers customize content at scale while keeping designs locked to brand.",
    openGraph: {
      title: "No-Fuss Creative Templating",
      description: "Enable fast, controlled content adaptations with easy-to-build templates directly inside Figma and Adobe.",
      images: [
        {
  ...
  heroSectionData: {
    ...
    features: [
      ...
      "Intelligent element control",
      "Automated format adaptation",
      "Preserved creative details",
  ...
  ctaData: {
    title: "See how CreateTOTALLY preserves your creative integrity while automating production.",
