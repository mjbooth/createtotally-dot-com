    ...
    <Box>
      <Box bg="brandNeutral.500">
        <FeatureHeroSection
          ...
          title="From design to dynamic - without compromise"
          subtitle="Use real Figma and Adobe files to create dynamic, reusable templates. No rebuilds. No handoffs. No delays."
          features={[
            "Adobe InDesign",
