...
export const metadata = {
  title: 'Director of Engineering and AI | CreateTOTALLY',
  description:
    'Join CreateTOTALLY as Director of Engineering and AI. Own the engineering function and product roadmap, lead AI capability development. London-based hybrid role reporting to the CEO.',
  alternates: {
    canonical: getStaticPageCanonicalUrl('careers/director-of-engineering-and-ai'),
  },
  openGraph: {
    title: 'Director of Engineering and AI | CreateTOTALLY',
    description:
      'Join CreateTOTALLY as Director of Engineering and AI. Own the engineering function and product roadmap, lead AI capability development.',
    url: getStaticPageCanonicalUrl('careers/director-of-engineering-and-ai'),
...
export default async function DirectorOfEngineeringPage() {
  const filePath = path.join(process.cwd(), 'public', 'careers', 'director-of-engineering-and-ai.md');
  const rawMarkdown = fs.readFileSync(filePath, 'utf-8');

  // Strip the metadata block (Location/Type/etc between first two ---) since the sidebar shows these
    ...
    <Box bg="brandNeutral.200" pt={{ base: '20', md: '40' }}>
      <Container maxW="1152px" px={{ base: 4, sm: 6, md: 8 }} py={{ base: 6, md: 12 }}>
        ...
        <Heading
          ...
          mb={{ base: 6, lg: 8 }}
        >
          Director of Engineering and AI
        </Heading>
